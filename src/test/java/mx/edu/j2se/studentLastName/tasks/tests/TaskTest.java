...
public class TaskTest {
    ...
    void Test1() {
        ...
        Task task2=new Task("Wake up in the morning",LocalDateTime.parse("2020-01-01T06:00:00"),LocalDateTime.parse("2021-12-31T06:00:00"), Period.ofDays(5));
        Assertions.assertFalse( !task.isActive());
        task2.setActive(true);
        Assertions.assertTrue(task2.isActive());
        task.setActive(true);
        Assertions.assertEquals(Period.ofDays(5),task2.getRepeatInterval());
    ...
    void TestNextTimeAfter() {
        Task t=new Task("T1",LocalDateTime.parse("2022-01-05T00:00:00"),LocalDateTime.parse("2022-01-20T00:00:00"), Duration.ofHours(12));
        Task t1=new Task("T1",LocalDateTime.parse("2020-01-01T00:00:00"),LocalDateTime.parse("2022-01-21T00:00:00"),Period.ofDays(24));
        t.setActive(true);
        t1.setActive(true);
